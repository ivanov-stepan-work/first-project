...
<head>
    ...
    <title>Отчёт для кураторов</title>
    er: 1px solid;
...
<td style="text-align:right; font-size: 15px; font-weight: bold;">Приложение №2</td>
</tr>
</table>';
...
foreach ($groups as $group) {
    ...
    <tr>
        ...
        <th style="width:30%; font-size: 14px;">Обучающийся</th>
        <th style="width:20%; font-size: 14px;">Тема индивидуального проекта</th>
        <th style="width:20%; font-size: 14px;">Преподаватель</th>
        <th style="width:20%; font-size: 14px;">Оценка</th>
    </tr>';
    ...
    foreach($tests as $test) {
        ...
        <td style="width:20%; font-size: 14px;">' . $test['grade'] . '</td> 
    </tr>';
        $count++;
    }
...
$dt = Date('d-m-y');
$mpdf->WriteHTML($html);
$mpdf->Output('ИПС-Отчет-для-кураторов_' . $dt . '.pdf', 'I');
?>