...
if (isset($_POST['login'], $_POST['lastname'], $_POST['firstname'], $_POST['middlename'])){
...
$stmt->execute();
$connect->exec("INSERT INTO `roles_users` (`role_id`, `user_id`) VALUES ('3', LAST_INSERT_ID())");}
header("Location: front_table_teachers.php");
} 
catch (PDOException $e) {
    if ($e->getCode() === '23000') {
        $_SESSION['error_login_exists'] = 1;
    } else {
